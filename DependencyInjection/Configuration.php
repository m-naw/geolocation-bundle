        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('address')
                    ...
                    ->children()
                        ->scalarNode('entity_class')
                            ->defaultValue('Meup\Bundle\GeoLocationBundle\Model\Address')
                        ->end()
                        ->scalarNode('factory_class')
                            ->defaultValue('Meup\Bundle\GeoLocationBundle\Factory\AddressFactory')
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('coordinates')
                    ...
                    ->children()
                        ->scalarNode('entity_class')
                            ->defaultValue('Meup\Bundle\GeoLocationBundle\Model\Coordinates')
                        ->end()
                        ->scalarNode('factory_class')
                            ->defaultValue('Meup\Bundle\GeoLocationBundle\Factory\CoordinatesFactory')
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('handlers')
                    ...
                    ->children()
                        ->scalarNode('distance_calculator')
                            ->defaultValue('Meup\Bundle\GeoLocationBundle\Handler\DistanceCalculator')
                        ->end()
                        ->scalarNode('locator_manager')
                            ->defaultValue('Meup\Bundle\GeoLocationBundle\Handler\LocatorManager')
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('balancer')
                    ...
                    ->children()
                        ->scalarNode('strategy')
                            ->defaultValue('meup_geo_location.balancer.random_strategy')
                        ->end()
                        ->scalarNode('factory')
                            ->defaultValue('meup_geo_location.balancer_factory.default')
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('providers')
                    ...
                    ->children()
                        ->arrayNode('google')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->booleanNode('activated')->defaultFalse()->end()
                        ...
                        ->arrayNode('yandex')
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('heredotcom')
                            ->addDefaultsIfNotSet()
                                ->children()
                                    ->booleanNode('activated')->defaultFalse()->end()
                                    ->scalarNode('api_key')->defaultValue('%geo_location_heredotcom_api_key%')->end()
                                    ->scalarNode('api_endpoint')->defaultValue('https://geocoder.cit.api.here.com/6.2/geocode.json;https://reverse.geocoder.cit.api.here.com/6.2/reversegeocode.json')->end()
                                    ->scalarNode('locator_class')->defaultValue('Meup\Bundle\GeoLocationBundle\Provider\Heredotcom\Locator')->end()
                                    ->scalarNode('hydrator_class')->defaultValue('Meup\Bundle\GeoLocationBundle\Provider\Heredotcom\Hydrator')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
